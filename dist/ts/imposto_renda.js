...
var Pessoa_Fisica = /** @class */ (function (_super) {
    ...
    function Pessoa_Fisica(_gastos_saude) {
        var _this = _super.call(this, nome, renda) || this;
        _this._gastos_saude = _gastos_saude;
        return _this;
    }
    ...
    Pessoa_Fisica.prototype.imposto_fisica = function (renda) {
        if (renda < 20000) {
            if (this.gastos_saude > 0) {
                var imposto = (renda * 0.15) - (this._gastos_saude * 0.5);
            }
            else {
            ...
            if (this.gastos_saude > 0) {
                var imposto = (renda * 0.25) - (this._gastos_saude * 0.5);
            }
            else {
                var imposto = (renda * 0.25);
            }
        }
    };
...
var Pessoa_juridica = /** @class */ (function (_super) {
    ...
    function Pessoa_juridica(_numero_funci) {
        var _this = _super.call(this, nome, renda) || this;
        _this._numero_funci = _numero_funci;
        return _this;
    }
    ...
    Pessoa_juridica.prototype.imposto_juridico = function (renda, _numero_funci) {
        if (_numero_funci >= 10) {
            var imposto = renda * 0.14;
        }
        else {
            var imposto = renda * 0.16;
        }
    };
